...
<!--startprint-->
	...
	<div id="tb">
		<div>
			...
			<a href="javascript:shangchuanSjduochu()" class="easyui-linkbutton" iconCls="icon-add" plain="true">上传详情</a>
		</div>
		<div>
...
<!--endprint-->
	<div id="dlg" class="easyui-dialog" style="width: 540px;height: 260px;padding: 10px 20px" closed="true" buttons="#dlg-buttons">
		<form id="fm" method="post">
			<table cellspacing="5px;">
				...
				<tr>
					<td valign="top">详情：</td>
					<td colspan="4"><textarea rows="7" cols="55" name="sjduochumark" id="sjduochumark"></textarea></td>
				</tr>
			</table>
		</form>
	</div>
